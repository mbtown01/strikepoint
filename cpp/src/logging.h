...
#define LOG_DEBUG(l, fmt, ...) \
    l.log(__FILE__, __LINE__, LOG_LEVEL_DEBUG, fmt, ##__VA_ARGS__)
#define LOG_INFO(l, fmt, ...) \
    l.log(__FILE__, __LINE__, LOG_LEVEL_INFO, fmt, ##__VA_ARGS__)
#define LOG_WARNING(l, fmt, ...) \
    l.log(__FILE__, __LINE__, LOG_LEVEL_WARNING, fmt, ##__VA_ARGS__)
#define LOG_ERROR(l, fmt, ...) \
    l.log(__FILE__, __LINE__, LOG_LEVEL_ERROR, fmt, ##__VA_ARGS__)
#define LOG_CRITICAL(l, fmt, ...) \
    l.log(__FILE__, __LINE__, LOG_LEVEL_CRITICAL, fmt, ##__VA_ARGS__)
